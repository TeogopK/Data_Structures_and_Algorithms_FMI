...
**Note:** Няма конкретна теми за тази седмица. Всеки семинар ще покаже нещо различно в зависимост какво е преценил.

В прикачените материали са разгледани допълнителни техники/структури, **които не са пряко включени в курса**, но могат да бъдат полезни при интервютата ви в бъдеще - Cache eviction algorithms, Prefix sum, Trie.
