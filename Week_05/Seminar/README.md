...
- [Python deque](https://docs.python.org/3/library/collections.html#collections.deque) - използваме дек, double ended queue, което играе ролята на двойно свързан списък. Може да се ползва и като стек, и като опашка.
...
- [Python list](https://docs.python.org/3/tutorial/datastructures.html#using-lists-as-stacks). Отново можем да ползваме дек или обикновен лист, тъй като `.append` и `.pop` са О(1) в средния случай - [справка](https://wiki.python.org/moin/TimeComplexity).
...
- [Python](https://docs.python.org/3/library/collections.html#collections.deque)
...
monotonicStackExample([4, 1, 2, 6, 7, 3])
# credit: https://github.com/stoychoX/Data-structures-and-algorithms/
```

</details>

Какво можем да забележим от този пример? Примерно, вярно е, че при i = k, максимумът на подмасива [0..k - 1] е на дъното на стека.
