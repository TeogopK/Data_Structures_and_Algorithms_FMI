...
Структура от данни предназначена за работа с несвързани множества. Първоначално всеки елемент е в свое си множество.
...
(Самата структура може да бъде имплементира по много начини.)

### Детайли на имплементация
Може да намерите имплементация в съответната папка.
