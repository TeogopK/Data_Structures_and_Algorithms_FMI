...
Може да намерите възможни имплементации в съответната папка, както и в [playground-а](playground_14.ipynb). (Самата структура може да бъде имплементира по много начини.)
