...
Ако ще правим поне logN заявки върху масив (пример: q1: дай ми най-големия елемен, q2: дай ми четвъртия по големина, q3... или някакви други подобни), е по-оптимално първо да сортираме масива за да можем по-бързо да отговаряме на заявките.
